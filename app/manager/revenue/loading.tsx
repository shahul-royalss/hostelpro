...
export default function ManagerRevenueLoading() {
  return (
    <div aria-busy="true" aria-label="Loading">
      ...
      {/* Add revenue card — single row form on lg */}
      <GlassCard>
        <div className="mb-4 space-y-2">
          <Skeleton className="h-5 w-32" />
          <Skeleton className="h-3.5 w-96" />
        </div>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-[1fr_1fr_1fr_1.6fr_auto]">
      ...
      <GlassCard padded={false} className="mt-6">
        <div className="p-5 pb-0 md:p-6 md:pb-0">
          ...
          <Skeleton className="mb-4 h-8 w-72 rounded-full" />
        </div>
